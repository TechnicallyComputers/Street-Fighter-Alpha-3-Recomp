...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Street Fighter Alpha 3",
    .project_root_env = "STREET_FIGHTER_ALPHA_3_RECOMP_PROJECT_ROOT",
    .build_dir_env = "STREET_FIGHTER_ALPHA_3_RECOMP_BUILD_DIR",
    .force_setup_env = "STREET_FIGHTER_ALPHA_3_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.21_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Street_Fighter_Alpha_3__Recompiled",
    .prepare_note =
